      ...
      <a href="index.html" class="app-brand-link">
        <span class="app-brand-logo demo me-1">
          <span style="color: var(--bs-primary)">
            <svg version="1.1" viewBox="0 0 2048 1401" width="1280" height="1280" xmlns="http://www.w3.org/2000/svg">
        ...
        <span style="font-size: 15px" class="app-brand-text demo menu-text fw-bold ms-1">Tata Metal Lestari</span>
      </a>
