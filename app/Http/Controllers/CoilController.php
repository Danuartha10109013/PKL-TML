...
class CoilController extends Controller
{
    ...
    public function index($no_gs){
        ...
        return view('content.dashboard.coiling', compact('data','same'));
    }
    public function create($no_gs){
        ...
        return view('content.dashboard.tambahcoil', compact('data','same'));
    }
    ...
    public function indexs(){
        $data = Coil::all();
        return view('content.dashboard.coil', compact('data'));
    }
}
